        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex items-center gap-3">
                    <svg class="w-8 h-8 text-white/90" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="/dashboard" class="text-xl font-bold text-white">Mochin-Kuis</a>
                </div>
                @auth
                <div class="flex items-center gap-4">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class="text-sm text-blue-300 hover:text-white transition cursor-pointer flex items-center gap-1">
